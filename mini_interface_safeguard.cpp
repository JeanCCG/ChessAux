...
enum User_input : bool { next, previous };
...
int main()
{
  ...
  while (true) {
    ...
    //   // Loop until the user inputs the escape key
    //   while (true) {
    //     int ch = getch();
    //     switch (ch) {
    //     case KEY_UP: std::cout << "Up arrow key" << std::endl; break;
    //     case KEY_DOWN: std::cout << "Down arrow key" << std::endl; break;
    //     case KEY_LEFT: std::cout << "Left arrow key" << std::endl; break;
    //     case KEY_RIGHT: std::cout << "Right arrow key" << std::endl; break;
    //     case KEY_ENTER:
    //     case '\n': std::cout << "Enter key" << std::endl; break;
    //     case 27: std::cout << "Escape key" << std::endl; goto end;
    //     default: std::cout << "Other key" << std::endl; break;
    //     }
    //   }
